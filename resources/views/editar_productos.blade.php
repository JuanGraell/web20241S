        ...
        <form action="{{route('productos.update',$producto->id)}}" method="POST">
            ...
            <div class="mb-3">
                <label for="nom" class="form-label">Nombre:
                    <input type="text" id="nom" name="nom" class="form-control" value="{{$producto->nombre}}" required>
                </label>
            </div>
            <div class="mb-3">
                <label for="descri" class="form-label">Descripción:
                    <input type="text" id="descri" name="descri" class="form-control" value="{{$producto->descripcion}}" required>
                </label>
            </div>
            <div class="mb-3">
